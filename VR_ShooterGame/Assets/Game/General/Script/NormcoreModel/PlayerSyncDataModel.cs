...
public partial class PlayerSyncDataModel 
{
    ...
    private bool _playerIsCanEnterNextLV;
}
...
public partial class PlayerSyncDataModel : RealtimeModel {
    ...
    public bool playerIsCanEnterNextLV {
        get {
            return _playerIsCanEnterNextLVProperty.value;
        }
        set {
            if (_playerIsCanEnterNextLVProperty.value == value) return;
            _playerIsCanEnterNextLVProperty.value = value;
            InvalidateReliableLength();
            FirePlayerIsCanEnterNextLVDidChange(value);
        }
    }
    ...
    public event PropertyChangedHandler<bool> playerIsCanEnterNextLVDidChange;
    ...
    private ReliableProperty<bool> _playerIsCanEnterNextLVProperty;
    ...
    public PlayerSyncDataModel() : base(null) {
        ...
        _playerIsCanEnterNextLVProperty = new ReliableProperty<bool>(6, _playerIsCanEnterNextLV);
    }
    ...
    protected override void OnParentReplaced(RealtimeModel previousParent, RealtimeModel currentParent) {
        ...
        _playerIsCanEnterNextLVProperty.UnsubscribeCallback();
    }
    ...
    private void FirePlayerIsCanEnterNextLVDidChange(bool value) {
        try {
            playerIsCanEnterNextLVDidChange?.Invoke(this, value);
        } catch (System.Exception exception) {
            UnityEngine.Debug.LogException(exception);
        }
    }
    ...
    protected override int WriteLength(StreamContext context) {
        ...
        length += _playerIsCanEnterNextLVProperty.WriteLength(context);
        return length;
    }
    ...
    protected override void Write(WriteStream stream, StreamContext context) {
        ...
        writes |= _playerIsCanEnterNextLVProperty.Write(stream, context);
    ...
    protected override void Read(ReadStream stream, StreamContext context) {
        ...
        while (stream.ReadNextPropertyID(out uint propertyID)) {
            ...
            switch (propertyID) {
                ...
                case (uint) PropertyID.PlayerIsCanEnterNextLV: {
                    changed = _playerIsCanEnterNextLVProperty.Read(stream, context);
                    if (changed) FirePlayerIsCanEnterNextLVDidChange(playerIsCanEnterNextLV);
                    break;
                }
                default: {
                    stream.SkipProperty();
    ...
    private void UpdateBackingFields() {
        ...
        _playerIsCanEnterNextLV = playerIsCanEnterNextLV;
    }
